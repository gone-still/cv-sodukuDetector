# File        :   svmCreator.py
# Version     :   1.0.0
# Description :   Script that trains, tests and generates a SVM-based per-number
#                 model using scanned samples.
# Date:       :   May 01, 2022
...
# samples path:
rootDir = "D:"
path = os.path.join(rootDir, "opencvImages", "sudoku", "samples")
...
modelPath = os.path.join(rootDir, "opencvImages", "sudoku", "model")
